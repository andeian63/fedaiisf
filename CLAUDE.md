...
**Per `publicUrl`:** sempre nel formato `https://fedaiisfnewsletter.vercel.app/editions/YYYY-MM-DD/`.
...
> https://fedaiisfnewsletter.vercel.app/editions/YYYY-MM-DD/
>
...
URL pubblico base: `https://fedaiisfnewsletter.vercel.app/`
Le edizioni vivono in `/editions/YYYY-MM-DD/` → URL `https://fedaiisfnewsletter.vercel.app/editions/YYYY-MM-DD/`
