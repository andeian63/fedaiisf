...
**Per `publicUrl`:** sempre nel formato `https://fedaiisf-wine.vercel.app/editions/YYYY-MM-DD/`.
...
> https://fedaiisf-wine.vercel.app/editions/YYYY-MM-DD/
>
...
URL pubblico base: `https://fedaiisf-wine.vercel.app/`
Le edizioni vivono in `/editions/YYYY-MM-DD/` → URL `https://fedaiisf-wine.vercel.app/editions/YYYY-MM-DD/`
